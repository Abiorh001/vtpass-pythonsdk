...
class DataSubscriptionSchema(BaseModel):
    ...
    billers_code: str = Field(
        ...,
        title="Phone Number",
        description="This is the phone number or email address if it is for smile-direct on which you want to make the subscription payment. It identifies the subscriber's account.",
    )
    amount: Optional[int] = Field(
        None,
        title="Amount",
        description="This amount will be ignored as the variation code determine the price of the data bundle.",
    )
    ...
    phone: str = Field(
        ...,
        title="Phone Number",
        description=" This is the phone number of the customer or the recipient who will receive the data subscription. It identifies who the service is being provided to.",
    )
...
class VerifySmileEmailSchema(BaseModel):
    service_id: str = Field(
        ...,
        title="Service ID",
        description="Service ID as specified by VTpass. e.g smile-direct",
    )
    billers_code: str = Field(
        ..., title="	The smile email you wish to make the Subscription payment on"
    )
