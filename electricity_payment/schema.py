...
class VerifyMeterValueSchema(BaseModel):
    service_id: ElectricityServiceIdEnum = Field(..., title="Service ID", description="Service ID as specified by VTpass. e.g ikeja-electric, eko-electric, abuja-electric, kano-electric, portharcourt-electric, kaduna-electric, ibadan-electric, jos-electric, enugu-electric, aba-electric, yola-electric, benin-electric")
    type: MeterTypeEnum = Field(..., title="Meter Type", description="The type of meter e.g prepaid, postpaid")
    billers_code: str = Field(..., title="Billers Code", description="The meter number you wish to make the bills payment on.")
...
class ElectricityPaymentSchema(BaseModel):
    ...
    variation_code: MeterTypeEnum = Field(..., title="Meter Type", description="The type of meter e.g prepaid, postpaid")
