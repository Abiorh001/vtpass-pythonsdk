...
class TVSubscriptionSchema(BaseModel):
    ...
    billers_code: str = Field(..., title="Smart Card Number", description="The smart card number you wish to make the Subscription payment on")
    ...
    subscription_type: Optional[SubscriptionTypeEnum] = Field(None, title="Subscription Type", description="The type of subscription in this case change.")
    quantity: Optional[int] = Field(None, title="Quantity", description="The number of months viewing month e.g 1")
...
class VerifySmartCardNumberSchema(BaseModel):
    service_id: str = Field(..., title="Service ID", description="Service ID as specified by VTpass. e.g dstv")
    billers_code: str = Field(..., title="The smart card number you wish to make the Subscription payment on")
