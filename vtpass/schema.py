...
class ServiceIdentifierSchema(BaseModel):
    identifier: ServiceIdentifierEnum = Field(
        ...,
        title="Service Identifier",
        description="The identifier of the service e.g airtime, data, tv-subscription, electricity-bill, education, funds, events, other-services, insurance",
    )
...
class ServiceIdVariationSchema(BaseModel):
    service_id: ServiceIdVariationEnum = Field(
        ...,
        title="Service ID",
        description="The service id of the service e.g mtn-data, glo-data, airtel-data, dstv, gotv, startimes, showmax, smile-direct, spectranet, 9mobile-sme-data, waec, waec-registration, jamb, ikeja-electric, eko-electric, abuja-electric, kano-electric, portharcourt-electric, kaduna-electric, ibadan-electric, jos-electric, enugu-electric, aba-electric, yola-electric, benin-electric, bank-deposit, ui-insure, health-insurance-rhl, personal-accident-insurance, home-cover-insurance, web-design-deal",
    )
...
class ProductOptionSchema(BaseModel):
    ...
    service_id: ServiceIdSchema = Field(
        ...,
        title="Service ID",
        description="The service id of the service e.g mtn, glo, airtel, etisalat, dstv, gotv, startimes, airtel, smile, spectranet",
    )
